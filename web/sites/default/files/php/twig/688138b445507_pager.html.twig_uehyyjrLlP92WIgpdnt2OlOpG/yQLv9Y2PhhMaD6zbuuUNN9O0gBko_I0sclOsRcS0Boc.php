...
/* themes/contrib/nava/templates/navigation/pager.html.twig */
class __TwigTemplate_320d4e6888951553c2c7da14c0f8b1aa extends Template
{
    ...
    <ul class=\"pager-items js-pager__items\">
      ";
            ...
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "first", [], "any", false, false, true, 38)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 39
                yield "        <li class=\"pager-item pager-item-first pager__item--first\">
          <a href=\"";
                // line 40
      ...
      ";
            ...
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "previous", [], "any", false, false, true, 47)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 48
                yield "        <li class=\"pager-item pager-item-arrow pager-item-previous pager__item--previous\">
          <a href=\"";
                // line 49
      ...
      ";
            ...
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "next", [], "any", false, false, true, 80)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 81
                yield "        <li class=\"pager-item pager-item-arrow pager-item-next pager__item--next\">
          <a href=\"";
                // line 82
      ...
      ";
            ...
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "last", [], "any", false, false, true, 89)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 90
                yield "        <li class=\"pager-item pager-item-last pager__item--last\">
          <a href=\"";
                // line 91
...
";
    ...
    {
        return "themes/contrib/nava/templates/navigation/pager.html.twig";
    }
    ...
    {
        return new Source("", "themes/contrib/nava/templates/navigation/pager.html.twig", "/var/www/html/drupal_11/web/themes/contrib/nava/templates/navigation/pager.html.twig");
    }
