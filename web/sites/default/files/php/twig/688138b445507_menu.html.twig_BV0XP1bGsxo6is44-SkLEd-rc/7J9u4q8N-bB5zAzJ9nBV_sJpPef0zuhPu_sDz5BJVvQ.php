...
$context["item"], "below", [], "any", false, false, true, 42)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("menu-item-has-children") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/nava/templates/navigation/menu.html.twig", "/var/www/html/drupal_11/web/themes/contrib/nava/templates/navigation/menu.html.twig");
    }
