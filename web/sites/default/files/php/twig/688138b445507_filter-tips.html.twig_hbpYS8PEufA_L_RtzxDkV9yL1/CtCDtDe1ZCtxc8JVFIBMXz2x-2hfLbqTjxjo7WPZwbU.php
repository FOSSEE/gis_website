...
class __TwigTemplate_1a45c7387c4b5328839ebd7121edae8e extends Template
{
...
($context["long"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-tips.html.twig", "/var/www/html/drupal_11/web/core/themes/claro/templates/filter/filter-tips.html.twig");
    }
